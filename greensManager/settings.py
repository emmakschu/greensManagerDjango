"""
Django settings for greensManager project.
...
SECRET_KEY = 'um*ue=x=3&)2n$cy6grq^(j50eo_-n3pt@%@dsy$v0ii6464yx'
...
ROOT_URLCONF = 'greensManager.urls'
...
WSGI_APPLICATION = 'greensManager.wsgi.application'
